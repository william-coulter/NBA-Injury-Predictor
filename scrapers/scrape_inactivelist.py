# -*- coding: utf-8 -*-
"""
This script scrapes the website www.prosportstransactions.com for
NBA inactive list data and builds a data frame using that data.  Each row 
corresponds to an inactive list "event" for a player. The columns are:
date (of event), player's team, name of player moving off inactive list,
name of player moving on to the inactive list, additional notes. This data 
frame is then saved as a .csv file for later use.
